  ...
  switch (action.actionType) {
    ...
    case appConstants.APP_APPLY_SITE_RECORDS:
      action.records.forEach((record) => {
        ...
        appState = syncUtil.updateObjectCache(appState, siteDetail)
      })
    ...
    case appConstants.APP_ADD_SITE:
      ...
      appState = syncUtil.updateObjectCache(appState, action.destinationDetail || action.siteDetail)
      appState = aboutNewTabState.setSites(appState, action)
      appState = aboutHistoryState.setHistory(appState, action)
      break
    case appConstants.APP_REMOVE_SITE:
      ...
      appState = syncUtil.updateObjectCache(appState, action.siteDetail)
      appState = aboutNewTabState.setSites(appState, action)
      appState = aboutHistoryState.setHistory(appState, action)
      break
    case appConstants.APP_MOVE_SITE:
      {
        ...
        appState = syncUtil.updateObjectCache(appState, action.destinationDetail)
        break
      }
